...
const ChatBot = () => {
  ...
  const callGeminiAPI = async (userMessage) => {
    const GEMINI_API_KEY = "AIzaSyAwmgxwqmfzr6PQZrLZCzEZlM_SXrvkn18";
    const GEMINI_MODEL = 'gemini-2.5-flash-lite'; // Có thể đổi sang gemini-1.5-pro, gemini-1.5-flash, etc.
